...
assert total_salary(file_one) == (33000, 11000), "Test case 1 failed"

# TestCase2 file wich does not exist (should )
assert total_salary(file_one) == "File does not exist", "Test case 2 failed"
...
assert total_salary(file_one) == "To calculate total salary and average salary salary should be written in numbers", "Test case 3 failed"
