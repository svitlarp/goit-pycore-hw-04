        ...
        if stat(path).st_size == 0:
            ...
            with open(path, "r", encoding='utf-8') as file_obj:
                ...
                if len(list_salary) > 1:
                    ...
                    return f'The salary is {list_salary[0]}. File contains only one raw'    
...
assert total_salary(file_four) == 'The salary is 7000. File contains only one raw', "Test case 4 failed"
